...
import venues from './venueData'; // Import venue data

export const VenueDetails = () => {
  const { id } = useParams();
  const venue = venues.find((v) => v.id === id); // Find the venue by ID
          ...
          <div className="p-6">
            ...
            <motion.button
              ...
              onClick={() => {
                ...
                const whatsappURL = `https://wa.me/919789210135?text=${encodeURIComponent(message)}`;
